                        ...
                        <div class="card-body py-4 px-4 px-md-5">
                            ...
                            <div class="pb-4">
                                        ...
                                        <h5 style="text-align: right; margin-right:50px;">Fillter</h5>
                                            <div class="mr-3">
                                                <a href="index.php" class="btn btn-secondary" style="margin-right: 15px;">All Task</a>
                                            </div>
                                            <div class="mr-3">
                                            <a href="pending.php" class="btn btn-danger mr-3">Pending Task</a>
                            ...
                            $tasks = mysqli_query($db, "SELECT * FROM task where is_deleted = 0 AND status = 1");
